...
def dividir_dataset(df, train_percentage=0.8, test_percentage=0.2, randomized=False, residential_perc=14605, industrial_perc=1473, public_perc=1433, retail_perc=897, office_perc=678, other_perc=1361, agriculture_perc=200):
    np.random.seed(7)
